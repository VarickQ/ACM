...
//判线段和圆相交, 包括端点和相切
int intersect(point c,double r,line l)
{
	double t1=distance(c,l.a)-r,t2=distance(c,l.b)-r;
	point t=c;
	if (t1<eps||t2<eps)
		return t1>-eps||t2>-eps;
	t.x+=l.a.y-l.b.y,t.y+=l.b.x-l.a.x;
	return xmult(l.a,c,t)*xmult(l.b,c,t)<eps&&ptoline(c,l)-r<eps;
}
int intersect(point c,double r,point l1,point l2)
{
	...
	if (t1<eps||t2<eps)
		return t1>-eps||t2>-eps;
	t.x+=l1.y-l2.y,t.y+=l2.x-l1.x;
	return xmult(l1,c,t)*xmult(l2,c,t)<eps&&ptoline(c,l1,l2)-r<eps;
}